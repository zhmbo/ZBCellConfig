...
-  (NSMutableArray<NSArray<ZBCellConfig *> *> *)cellConfigs
{
    ...
    // cell1
    ZBCellConfig *cell1Config = [ZBCellConfig cellConfigWithClass:[LowTableViewCell1 class]
                                               showCellInfoMethod:@selector(setModel:)];
    [_cellConfigs addObject:@[cell1Config]];
    
    // cell2
//    ZBCellConfig *cell2Config = [ZBCellConfig cellConfigWithClass:[LowTableViewCell1 class]
//                                               showCellInfoMethod:@selector(setModel:)];
//    [_cellConfigs addObject:@[cell2Config]];
    
    // cell3
    ZBCellConfig *cell3Config = [ZBCellConfig cellConfigWithClass:[LowTableViewCell1 class]
                                               showCellInfoMethod:@selector(setModel:)];
    [_cellConfigs addObject:@[cell3Config]];
